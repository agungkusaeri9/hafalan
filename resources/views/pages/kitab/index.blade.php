            ...
            <div class="card shadow">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h6>Data Kitab</h6>
                        <a href="{{ route('kitab.create') }}" class="btn btn-sm btn-primary">Tambah Kitab</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('kitab.edit', $item->id) }}" class="btn btn-info btn-sm">Edit</a>
                                            <form action="{{ route('kitab.destroy', $item->id) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
